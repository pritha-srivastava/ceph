...
TEST_F(ObjectDirectoryFixture, UpdateFieldYield)
{
  spawn::spawn(io, [this] (spawn::yield_context yield) {
    ...
    ASSERT_EQ(0, dir->update_field(env->dpp, obj, "hosts", "127.0.0.1:5000", optional_yield{io, yield}));
...
TEST_F(BlockDirectoryFixture, UpdateFieldYield)
{
  spawn::spawn(io, [this] (spawn::yield_context yield) {
    ...
    ASSERT_EQ(0, dir->update_field(env->dpp, block, "hosts", "127.0.0.1:5000", optional_yield{io, yield}));
