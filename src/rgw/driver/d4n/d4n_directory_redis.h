...
class RedisDirectory: public Directory {
  public:
...
class RedisBucketDirectory: public RedisDirectory {
  public:
    RedisBucketDirectory(std::shared_ptr<connection>& conn) : conn(conn) {}
...
class RedisObjectDirectory: public RedisDirectory {
  public:
    RedisObjectDirectory(std::shared_ptr<connection>& conn) : conn(conn) {}
...
class RedisBlockDirectory: public RedisDirectory {
  public:
    RedisBlockDirectory(std::shared_ptr<connection>& conn) : conn(conn) {}
