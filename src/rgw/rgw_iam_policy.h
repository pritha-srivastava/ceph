...
static constexpr std::uint64_t stsAssumeRole = 68;

static constexpr std::uint64_t s3Count = s3DeleteObjectVersionTagging + 1;
static constexpr std::uint64_t allCount = stsAssumeRole + 1;
...
static const Action_t iamAllValue("111111111111111111111111111111111111111111111111111111111111111111111");
